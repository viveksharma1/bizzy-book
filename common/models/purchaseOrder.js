...
module.exports = function(PurchaseOrder) {
    ...
    var DataSource = require('loopback-connector-mongodb');
     ...
     PurchaseOrder.getPo = function (ctx, req, cb) {
       ...
       var tokdata = jwt.verify(tok, "vivek",  {   
         ...
         console.log(role);
          PurchaseOrder.getDataSource().connector.connect(function (err, db) {
            var collection = db.collection('purchaseOrder');
            PurchaseOrder.find({where:{role:role}},
